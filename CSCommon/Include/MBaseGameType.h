...
inline bool MBaseGameTypeCatalogue::IsTeamExtremeGame(MMATCH_GAMETYPE nGameType)
{
	...
	if ((nGameType == MMATCH_GAMETYPE_DEATHMATCH_TEAM2) || (nGameType == MMATCH_GAMETYPE_PAINTBALL_TEAM) || (nGameType == MMATCH_GAMETYPE_CTF))
	{
		return true;
	}
	return false;
