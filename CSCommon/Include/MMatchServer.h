...
protected:
	...
	unsigned long int CustomEventTimers[1];
	//int reply[200];
...
protected:
	...
	bool StageJoin(const MUID& uidPlayer, const MUID& uidStage, bool rejoin = false, MMatchTeam Team = MMT_ALL); /// PlayGunZ: <Rejoin clan war>
...
protected:
	...
	void OnCreateEvent(bool bPrivate, char* pszStagePassword, MMATCH_GAMETYPE Type, int Limit, int reward, int Players);
