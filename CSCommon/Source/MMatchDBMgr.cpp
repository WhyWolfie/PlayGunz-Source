...
bool MMatchDBMgr::BuyBountyItem(const unsigned int nCID, const unsigned int nAID, int nItemID, int nItemCount, int nPrice, const DWORD dwRentHourPeriod, const bool bIsSpendableItem, unsigned long int* poutCIID, int nBuyMode) /// PlayGunZ: <nBuyMode>
{
	_STATUS_DB_START;
	if (!CheckOpen()) return false;
