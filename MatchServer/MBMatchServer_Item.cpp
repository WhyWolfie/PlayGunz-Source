...
void MBMatchServer::OnRequestBuyItem(const MUID& uidPlayer, const unsigned long int nItemID, const int nItemCount)
{
	...
	int		nBuyMode = 0; /// PlayGunZ: <nBuyMode>
	...
	if (!CheckUserCanBuyItem(pObj, nItemID, nItemCount, dwPrice, nBuyMode)) /// PlayGunZ: <nBuyMode>
	{
		return;
	}

	ResponseBuyItem(pObj, nItemID, nItemCount, bIsGambleItem, dwPrice, nRentHourPeriod, bIsSpendableItem, nBuyMode); /// PlayGunZ: <nBuyMode>
}

bool MBMatchServer::ResponseBuyItem(MMatchObject* pObj, const unsigned long int nItemID, const int nItemCount
	, const bool bIsGambleItem, const DWORD dwPrice, const WORD wRentHourPeriod, const bool bIsSpendableItem, int nBuyMode) /// PlayGunZ: <nBuyMode>
{
	MMatchCharInfo* pCharInfo = pObj->GetCharInfo();

	/// PlayGunZ: <Añadido GetAccountInfo>
	...
	pBuyBountyItemJob->Input(pObj->GetUID(), pCharInfo->m_nCID, pAccountInfo->m_nAID, nItemID
		, nItemCount, dwPrice, wRentHourPeriod, bIsGambleItem, bIsSpendableItem, nBuyMode); /// PlayGunZ: <nBuyMode>
...
const bool MBMatchServer::CheckUserCanBuyItem(MMatchObject* pObj, const int nItemID, const int nItemCnt, const DWORD dwPrice, int nBuyMode) /// PlayGunZ: <nBuyMode>
{
	...
	/// PlayGunZ: <Comprar artículos de cash>
	...
	/// PlayGunZ: <Comprar artículos de event>
