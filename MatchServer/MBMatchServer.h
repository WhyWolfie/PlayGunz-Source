...
protected:
	...
	bool ResponseBuyItem(MMatchObject* pObj
		...
		, int nBuyMode); /// PlayGunZ: <nBuyMode>
	const bool CheckUserCanBuyItem(MMatchObject* pObj, const int nItemID, const int nItemCnt, const DWORD dwPrice, int nBuyMode); /// PlayGunZ: <nBuyMode>
