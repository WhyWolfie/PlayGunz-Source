...
void RSetTracksSize(int n)
{ 
switch (n)
{ 
case 0:
default:g_nTracksSize = 3; break; 
case 1:g_nTracksSize = 5; break; 
case 2:g_nTracksSize = 7; break; 
case 3:g_nTracksSize = 9; break; 
case 4:g_nTracksSize = 11; break; 
	}
}
/// PlayGunZ: <Flash Window>
void RFlashWindow()
{
	if (RIsActive())
		return;
