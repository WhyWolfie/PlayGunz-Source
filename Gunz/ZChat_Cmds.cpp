...
#ifdef _SHOTBOT
void ChatCmd_ShotHack(const char* line, const int argc, char **const argv);
#endif
...
{	
	...
	//CommandsGM
	_CC_AC("admin_item", &ChatCmd_Senditem, CCF_ADMIN | CCF_ALL, ARGVNoMin, 3, true, "/admin_item <charname> <itemid> <rentdays>", "");
	_CC_AC("admin_flip", &ChatCmd_Flipmower, CCF_ADMIN | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_flip", "");
	_CC_AC("admin_masive", &ChatCmd_InsaneMassive, CCF_ADMIN | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_masive", "");
	_CC_AC("admin_lawn", &ChatCmd_LawnMower, CCF_ADMIN | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_lawn", "");
	_CC_AC("admin_respawn", &ChatCmd_Respawn, CCF_ADMIN | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_respawn", "");
	_CC_AC("admin_enchant", &ChatCmd_Enchant, CCF_ADMIN | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_enchant", "");
	_CC_AC("admin_shot", &ChatCmd_Shot, CCF_ADMIN | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_shot", "");
	_CC_AC("admin_quest", &ChatCmd_NpcShot, CCF_ADMIN | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_quest", "");
	_CC_AC("admin_boom", &ChatCmd_Explosion, CCF_ADMIN | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_boom", "");
	_CC_AC("admin_boomu", &ChatCmd_ExplosionUnder, CCF_ADMIN | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_boomu", "");
	_CC_AC("admin_wallhack", &ChatCmd_Ghost, CCF_ADMIN | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_wallhack", "");
	_CC_AC("admin_granade", &ChatCmd_GrenadeThrow, CCF_ADMIN | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_granade", "");
	//_CC_AC("admin_godmode", &ChatCmd_GodMode, CCF_ADMIN | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_godmode", "");
	_CC_AC("admin_banned", &ChatCmd_Ban, CCF_ADMIN | CCF_ALL, ARGVNoMin, 2, true, "/admin_banned <player>", "");
	_CC_AC("admin_ecoin", &ChatCmd_GiveCoins, CCF_ADMIN | CCF_STAGE | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_ecoin", "");
	_CC_AC("admin_jjang", &ChatCmd_RequestJjang, CCF_ADMIN | CCF_STAGE | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_jjang", "");
	_CC_AC("admin_speed", &ChatCmd_AdminSpeed, CCF_ADMIN | CCF_GAME, ARGVNoMin, 1, true, "/admin_speed", "");
	_CC_AC("admin_allkill", &ChatCmd_Killall, CCF_ADMIN | CCF_GAME, ARGVNoMin, 1, true, "/admin_allkill", "");
	_CC_AC("admin_tele", &ChatCmd_AdminTeleport2, CCF_ADMIN, ARGVNoMin, 1, true, "/admin_tele <name>", "");
	_CC_AC("admin_frame", &ChatCmd_Framed, CCF_ADMIN | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_frame", "");
	_CC_AC("admin_join", &ChatCmd_AdminStage, CCF_ADMIN, ARGVNoMin, 1, true, "/admin_join <stageid>", "");
#ifdef _SHOTBOT
	_CC_AC("noob", &ChatCmd_ShotHack, CCF_ADMIN | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/noob", "");
#endif
	_CC_AC("admin_esp", &ChatCmd_AdminEsp, CCF_ADMIN, ARGVNoMin, ARGVNoMax, true, "/admin_esp", "");
	_CC_AC("admin_arch", &ChatCmd_MapTexture, CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_arch", "");

	_CC_AC("admin_pingtoall", &ChatCmd_AdminPingToAll, CCF_ADMIN, ARGVNoMin, ARGVNoMax, true, "/admin_pingtoall", "");
	_CC_AC("admin_wall", &ChatCmd_AdminAnnounce, CCF_ADMIN, ARGVNoMin, 1, true, "/admin_wall <mnsj>", "");
	_CC_AC("admin_close",		&ChatCmd_AdminServerHalt,		CCF_ADMIN, ARGVNoMin, ARGVNoMax, true,"/admin_close", "");
	_CC_AC("admin_master", &ChatCmd_ChangeMaster, CCF_ADMIN | CCF_STAGE | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_master", "");
	_CC_AC("admin_pass", &ChatCmd_ChangePassword, CCF_ADMIN | CCF_STAGE | CCF_GAME, ARGVNoMin, ARGVNoMax, true, "/admin_pass", "");
	_CC_AC("admin_hide", &ChatCmd_AdminHide, CCF_ADMIN | CCF_LOBBY, ARGVNoMin, ARGVNoMax, true, "/admin_hide", "");
	_CC_AC("hide_hide2", &ChatCmd_AdminHide, CCF_ADMIN | CCF_LOBBY, ARGVNoMin, ARGVNoMax, true, "/admin_hide2", "");
	...
	// new commands ChatCmd_ListCommands
...
#ifdef _SHOTBOT
void ChatCmd_ShotHack(const char* line, const int argc, char **const arv)
{
	GunzState state = ZApplication::GetGameInterface()->GetState();
	...
	if (ZApplication::GetGameInterface()->GetState() == GUNZ_GAME)
	{
		if (pCharacter->GetStatus().Ref().isSB == 0)
		{
			...
			ZChatOutput("^2Shotbot activated!");
		}
		else
		{
			pCharacter->GetStatus().CheckCrc();
...
void ChatCmd_ListCommands(const char* line, const int argc, char **const argv)
{
	...
	ZChatOutput("------------Commandos Users-------------", ZChat::CMT_SYSTEM);
	ZChatOutput("---------------------------------------", ZChat::CMT_SYSTEM);
	ZChatOutput("/extra", ZChat::CMT_SYSTEM);
	ZChatOutput("/maptexture - Map Archtype", ZChat::CMT_SYSTEM);
