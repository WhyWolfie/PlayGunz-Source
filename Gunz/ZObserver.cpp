...
/*#ifdef _GGZ
		if (ZGetMyInfo()->IsAdminGrade())
		{
			sprintf(szName, "[Staff]%s (HP:%d, AP:%d)", m_pTargetCharacter->GetUserName(), (int)m_pTargetCharacter->GetHP(), (int)m_pTargetCharacter->GetAP());
		}
		else if (ZGetMyInfo()->IsVipGrade())
		{
			sprintf(szName, "[VIP]%s (HP:%d, AP:%d)", m_pTargetCharacter->GetUserName(), (int)m_pTargetCharacter->GetHP(), (int)m_pTargetCharacter->GetAP());
		}
		else
		{
			sprintf(szName, "%s (HP:%d, AP:%d)", m_pTargetCharacter->GetUserName(), (int)m_pTargetCharacter->GetHP(), (int)m_pTargetCharacter->GetAP());
